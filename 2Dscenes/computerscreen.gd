...
# -------------------------------
# Scenes
const ASTEROID_SCENE := preload("res://2Dscenes/asteroid.tscn")
const BULLET_SCENE := preload("res://2Dscenes/bullet.tscn")
...
func exit_computer() -> void:
	GoalManager.update_quest("Go home.")
	...
	SceneManager.unload_scene("res://2Dscenes/computerscreen.tscn")
